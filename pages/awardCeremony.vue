  ...
  .awardCeremony
    ...
    .container
      .main_wrapper
        ...
        .awardCeremony_box
          .awardCeremony_box_title: p {{ $t('disclaimer.please') }}
          .awardCeremony_box_txt(v-html="disclaimer")
        .awardCeremony_checkbox(@click="toggleAgreement()")
          .awardCeremony_checkbox_icon
            CheckSvg.check_icon(v-if="agree")
          .awardCeremony_checkbox_txt {{ $t('disclaimer.agree') }}
        button(:disabled="!agree" @click="goToForm()" :class="{'agree_button--disabled': !agree}").agree_button {{ $t('disclaimer.toform') }}
    Footer
</template>
<script>
// components
import DisclaimerJa from '~/assets/awardCeremony-ja.md'
  ...
  methods: {
    ...
    goToForm() {
      window.location.href =
        'https://docs.google.com/forms/d/e/1FAIpQLSdYrruRdOEdtK5vB2nJ1GICAc6qWVmNE6Ls_6sM4DcfWowKbA/viewform'
    }
  },
  head() {
    return {
